...
CREATE
INDEX "categories_project_idx" ON "project_has_categories" USING "btree" ("project_id");
...
CREATE
INDEX "columns_project_idx" ON "columns" USING "btree" ("project_id");
...
CREATE
INDEX "comments_reference_idx" ON "comments" USING "btree" ("reference");
...
CREATE
INDEX "comments_task_idx" ON "comments" USING "btree" ("task_id");
...
CREATE
INDEX "files_task_idx" ON "task_has_files" USING "btree" ("task_id");
...
CREATE
UNIQUE INDEX "project_daily_column_stats_idx" ON "project_daily_column_stats" USING "btree" ("day", "project_id", "column_id");
...
CREATE
UNIQUE INDEX "project_daily_stats_idx" ON "project_daily_stats" USING "btree" ("day", "project_id");
...
CREATE
INDEX "subtasks_task_idx" ON "subtasks" USING "btree" ("task_id");
...
CREATE
INDEX "swimlanes_project_idx" ON "swimlanes" USING "btree" ("project_id");
...
CREATE
INDEX "task_has_links_task_index" ON "task_has_links" USING "btree" ("task_id");
...
CREATE
UNIQUE INDEX "task_has_links_unique" ON "task_has_links" USING "btree" ("link_id", "task_id", "opposite_task_id");
...
CREATE
INDEX "tasks_project_idx" ON "tasks" USING "btree" ("project_id");
...
CREATE
INDEX "tasks_reference_idx" ON "tasks" USING "btree" ("reference");
...
CREATE
INDEX "transitions_project_index" ON "transitions" USING "btree" ("project_id");
...
CREATE
INDEX "transitions_task_index" ON "transitions" USING "btree" ("task_id");
...
CREATE
INDEX "transitions_user_index" ON "transitions" USING "btree" ("user_id");
...
CREATE
UNIQUE INDEX "user_has_notification_types_user_idx" ON "user_has_notification_types" USING "btree" ("user_id", "notification_type");
...
CREATE
UNIQUE INDEX "users_username_idx" ON "users" USING "btree" ("username");
...
ALTER TABLE ONLY "action_has_params"
    ADD CONSTRAINT "action_has_params_action_id_fkey" FOREIGN KEY ("action_id") REFERENCES "actions"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "actions"
    ADD CONSTRAINT "actions_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "column_has_move_restrictions"
    ADD CONSTRAINT "column_has_move_restrictions_dst_column_id_fkey" FOREIGN KEY ("dst_column_id") REFERENCES "columns"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "column_has_move_restrictions"
    ADD CONSTRAINT "column_has_move_restrictions_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "column_has_move_restrictions"
    ADD CONSTRAINT "column_has_move_restrictions_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "project_has_roles"("role_id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "column_has_move_restrictions"
    ADD CONSTRAINT "column_has_move_restrictions_src_column_id_fkey" FOREIGN KEY ("src_column_id") REFERENCES "columns"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "column_has_restrictions"
    ADD CONSTRAINT "column_has_restrictions_column_id_fkey" FOREIGN KEY ("column_id") REFERENCES "columns"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "column_has_restrictions"
    ADD CONSTRAINT "column_has_restrictions_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "column_has_restrictions"
    ADD CONSTRAINT "column_has_restrictions_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "project_has_roles"("role_id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "columns"
    ADD CONSTRAINT "columns_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "comments"
    ADD CONSTRAINT "comments_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "group_has_users"
    ADD CONSTRAINT "group_has_users_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "groups"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "group_has_users"
    ADD CONSTRAINT "group_has_users_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "last_logins"
    ADD CONSTRAINT "last_logins_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "password_reset"
    ADD CONSTRAINT "password_reset_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_activities"
    ADD CONSTRAINT "project_activities_creator_id_fkey" FOREIGN KEY ("creator_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_activities"
    ADD CONSTRAINT "project_activities_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_activities"
    ADD CONSTRAINT "project_activities_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_daily_stats"
    ADD CONSTRAINT "project_daily_stats_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_daily_column_stats"
    ADD CONSTRAINT "project_daily_summaries_column_id_fkey" FOREIGN KEY ("column_id") REFERENCES "columns"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_daily_column_stats"
    ADD CONSTRAINT "project_daily_summaries_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_has_categories"
    ADD CONSTRAINT "project_has_categories_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_has_files"
    ADD CONSTRAINT "project_has_files_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_has_groups"
    ADD CONSTRAINT "project_has_groups_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "groups"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_has_groups"
    ADD CONSTRAINT "project_has_groups_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_has_metadata"
    ADD CONSTRAINT "project_has_metadata_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_has_notification_types"
    ADD CONSTRAINT "project_has_notification_types_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_has_roles"
    ADD CONSTRAINT "project_has_roles_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_has_users"
    ADD CONSTRAINT "project_has_users_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_has_users"
    ADD CONSTRAINT "project_has_users_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_role_has_restrictions"
    ADD CONSTRAINT "project_role_has_restrictions_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "project_role_has_restrictions"
    ADD CONSTRAINT "project_role_has_restrictions_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "project_has_roles"("role_id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "remember_me"
    ADD CONSTRAINT "remember_me_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "subtask_time_tracking"
    ADD CONSTRAINT "subtask_time_tracking_subtask_id_fkey" FOREIGN KEY ("subtask_id") REFERENCES "subtasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "subtask_time_tracking"
    ADD CONSTRAINT "subtask_time_tracking_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "swimlanes"
    ADD CONSTRAINT "swimlanes_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "task_has_external_links"
    ADD CONSTRAINT "task_has_external_links_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "task_has_files"
    ADD CONSTRAINT "task_has_files_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "task_has_links"
    ADD CONSTRAINT "task_has_links_link_id_fkey" FOREIGN KEY ("link_id") REFERENCES "links"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "task_has_links"
    ADD CONSTRAINT "task_has_links_opposite_task_id_fkey" FOREIGN KEY ("opposite_task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "task_has_links"
    ADD CONSTRAINT "task_has_links_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "task_has_metadata"
    ADD CONSTRAINT "task_has_metadata_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "subtasks"
    ADD CONSTRAINT "task_has_subtasks_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "task_has_tags"
    ADD CONSTRAINT "task_has_tags_tag_id_fkey" FOREIGN KEY ("tag_id") REFERENCES "tags"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "task_has_tags"
    ADD CONSTRAINT "task_has_tags_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "tasks"
    ADD CONSTRAINT "tasks_column_id_fkey" FOREIGN KEY ("column_id") REFERENCES "columns"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "tasks"
    ADD CONSTRAINT "tasks_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "tasks"
    ADD CONSTRAINT "tasks_swimlane_id_fkey" FOREIGN KEY ("swimlane_id") REFERENCES "swimlanes"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "transitions"
    ADD CONSTRAINT "transitions_dst_column_id_fkey" FOREIGN KEY ("dst_column_id") REFERENCES "columns"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "transitions"
    ADD CONSTRAINT "transitions_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "transitions"
    ADD CONSTRAINT "transitions_src_column_id_fkey" FOREIGN KEY ("src_column_id") REFERENCES "columns"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "transitions"
    ADD CONSTRAINT "transitions_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "transitions"
    ADD CONSTRAINT "transitions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "user_has_metadata"
    ADD CONSTRAINT "user_has_metadata_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "user_has_notification_types"
    ADD CONSTRAINT "user_has_notification_types_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "user_has_notifications"
    ADD CONSTRAINT "user_has_notifications_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "user_has_notifications"
    ADD CONSTRAINT "user_has_notifications_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
ALTER TABLE ONLY "user_has_unread_notifications"
    ADD CONSTRAINT "user_has_unread_notifications_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON
DELETE
CASCADE;
...
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('board_highlight_period', '172800', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('board_public_refresh_interval', '60', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('board_private_refresh_interval', '10', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('board_columns', '', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('webhook_token', 'd5afda7f7444f8600138b276ae9a3d1e36781c3111ed35a55fc1a3ca3ff5', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('api_token', '8814fa59e03411e82772826d166f5cf444324efefcf334ae64b4921d53f3', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('application_language', 'en_US', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('application_timezone', 'UTC', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('application_url', '', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('application_date_format', 'm/d/Y', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('project_categories', '', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('subtask_restriction', '0', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('application_stylesheet', '', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('application_currency', 'USD', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('integration_gravatar', '0', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('calendar_user_subtasks_time_tracking', '0', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('calendar_user_tasks', 'date_started', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('calendar_project_tasks', 'date_started', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('webhook_url', '', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('default_color', 'yellow', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('subtask_time_tracking', '1', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('cfd_include_closed_tasks', '1', 0, 0);
INSERT INTO settings (option, value, changed_by, changed_on)
VALUES ('password_reset', '1', 0, 0);
...
INSERT INTO links (id, label, opposite_id)
VALUES (1, 'relates to', 0);
INSERT INTO links (id, label, opposite_id)
VALUES (2, 'blocks', 3);
INSERT INTO links (id, label, opposite_id)
VALUES (3, 'is blocked by', 2);
INSERT INTO links (id, label, opposite_id)
VALUES (4, 'duplicates', 5);
INSERT INTO links (id, label, opposite_id)
VALUES (5, 'is duplicated by', 4);
INSERT INTO links (id, label, opposite_id)
VALUES (6, 'is a child of', 7);
INSERT INTO links (id, label, opposite_id)
VALUES (7, 'is a parent of', 6);
INSERT INTO links (id, label, opposite_id)
VALUES (8, 'targets milestone', 9);
INSERT INTO links (id, label, opposite_id)
VALUES (9, 'is a milestone of', 8);
INSERT INTO links (id, label, opposite_id)
VALUES (10, 'fixes', 11);
INSERT INTO links (id, label, opposite_id)
VALUES (11, 'is fixed by', 10);
...
VALUES ('admin', '$2y$10$0WR8YPAwOCrDQTRFjji6u.krMgA4PcVsmw3ypmXAkqFKFLwnFOpAG', 'app-admin');
